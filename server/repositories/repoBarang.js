...
exports.addInvenActive = async (data) => {
    await InvGudangAktif.create({tanggal: data.tanggal, jumlah: data.jumlah, InvBarangId: data.idBarang});
    return;
};
...
exports.addInvenDump = async (data) => {
    await InvGudangLama.create({tanggal: data.tanggal, jumlah: data.jumlah, keterangan: data.keterangan, InvBarangId: data.idBarang});
    return;
};
