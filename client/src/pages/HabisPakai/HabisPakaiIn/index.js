            ...
            <div style={{ flex: '0 0 auto' }}>
                ...
                <div className='row mb-1'>
                    ...
                    <div className='col-auto'>
                        <Button variant="Primary" style={{ backgroundColor: "orange", marginBottom: "10px" }} onClick={handleOpenModalItem} className={`${level==='2' ? 'd-none' : ''}`}>Tambah Item</Button>
                    </div>
                    <div className='col-auto'>
                        <Button variant="Primary" style={{ backgroundColor: "orange", marginBottom: "10px" }} onClick={handleOpenModalData} className={`${level==='2' ? 'd-none' : ''}`}>Tambah Data</Button>
                    </div>
                </div>
            </div>
