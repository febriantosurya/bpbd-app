...
// import docx
import { Document, Packer, Paragraph, ImageRun, Table as TableDoc, TableRow, TableCell, HeadingLevel, WidthType, VerticalAlign, TextRun, BorderStyle, Border, Underline, Break } from 'docx';
...
font: "Arial",
            ...
            const pWaktuKejadian = formattedTanggal.map((item) => {
                return new Paragraph({
                  children: [
                    new TextRun({
                      font: "Arial",
            ...
            const document = new Document({
                ...
                sections: [{
                    ...
                    children: [
                        ...
                        mainPoint("b. Kronologi Kejadian \t : "),
